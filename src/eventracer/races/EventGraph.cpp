...
//	printf("Add Arc:  %d ->  %d\n", source, target);
//	RaceHandler::Instance()->succSet[source].insert(target);
//	RaceHandler::Instance()->predSet[target].insert(source);
...
void SimpleDirectedGraph::deleteArc(int source, int target) {
	...
	printf("Delate Arc:  %d ->  %d\n", source, target);
//	RaceHandler::Instance()->succSet[source].erase(target);
//	RaceHandler::Instance()->predSet[target].erase(source);
}
